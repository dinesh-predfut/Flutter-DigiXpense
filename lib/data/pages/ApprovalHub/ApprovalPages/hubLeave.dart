...
class ApprovalHubViewEditLeavePage extends StatefulWidget {
  final bool isReadOnly;
  final bool status;
  final LeaveDetailsModel? leaveRequest;
  const ApprovalHubViewEditLeavePage({
    super.key,
                          ...
                          SearchableMultiColumnDropdownField<LeaveAnalytics>(
                            ...
                            onChanged: (code) {
                              ...
                              if (start == null ||
                                  ...
                                  controller.leaveCodeController.text.isEmpty)
                                return;
                                        ...
                                        Expanded(
                                          child: OutlinedButton(
                                            onPressed: () {
                                              ...
                                              print(
                                                'Leave status: ${leaveDay.approvalStatus}',
                                              );
                                            },
