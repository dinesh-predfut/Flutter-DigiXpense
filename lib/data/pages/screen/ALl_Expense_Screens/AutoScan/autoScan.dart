...
_loadSettings();
    ...
    setState(() {
      itemizeSections.add(
        ItemizeSection(
          ...
          // ✅ Prefill ONLY for first itemize
  ...
  Future<void> waitForDropdownDataAndSetValues() async {
    ...
    //     (e) => e.name == currencyController.text,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Obx(() {
                                        final isSaveLoading =
                                            controller
                                                .buttonLoaders['saveGE'] ??
                                            false;
                                        final isSubmitLoading =
                                            controller
                                                .buttonLoaders['submit'] ??
                                            false;
                                        final isAnyLoading = controller
                                            .buttonLoaders
                                            .values
