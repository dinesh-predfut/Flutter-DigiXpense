...
class MyExpenseReportsDashboard extends StatefulWidget {
  const MyExpenseReportsDashboard({super.key});

  @override
  State<MyExpenseReportsDashboard> createState() =>
      _MyExpenseReportsDashboardState();
}

class _MyExpenseReportsDashboardState extends State<MyExpenseReportsDashboard>
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      '${AppLocalizations.of(context)!.expense} ${AppLocalizations.of(context)!.reports}',
                ...
                const SizedBox(height: 12),
                if (PermissionHelper.canWrite("Expense Reports"))
                  Padding(
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              Navigator.pushNamed(
                                context,
                                AppRoutes.expensereportCreateScreen,
                              );
                            },
                            icon: const Icon(
                              Icons.add_circle,
                        ...
                        return Dismissible(
                          ...
                          confirmDismiss: (direction) async {
                            if (direction == DismissDirection.startToEnd) {
                              ...
                              // }
                              controller.expensenavigateToEditReportScreen(
                                context,
                                item.recId,
                                true,
                              );
  ...
  Widget _buildStyledCard(ReportModels item, BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        // if (item.expenseType == "PerDiem") {
        controller.expensenavigateToEditReportScreen(context, item.recId, true);
