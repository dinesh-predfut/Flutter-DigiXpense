...
class ExpenseReportWizardParent extends StatefulWidget {
  const ExpenseReportWizardParent({Key? key}) : super(key: key);

  @override
  _ExpenseReportWizardParentState createState() =>
      _ExpenseReportWizardParentState();
}

class _ExpenseReportWizardParentState extends State<ExpenseReportWizardParent> {
  int _currentStep = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> screens = [
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
  title: Text( '${AppLocalizations.of(context)!.expenseRequisition} ${AppLocalizations.of(context)!.reports}'),          centerTitle: true,
        ),
        body: Padding(  
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ReportModel>(
        context,
        listen: false,
      ).updateFunctionalAreaExpenseReport("Expense Requisition");
    });
  }
