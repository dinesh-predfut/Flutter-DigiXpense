  ...
  Widget build(BuildContext context) {
    ...
    : () {
        if (_formKey.currentState!.validate() && _validateForm()) {
          ...
          controller.lineItemControllers
            ..clear()
            ..addAll(itemizeControllers);
          controller.addToFinalItemsUnProcess(widget.items);
          ...
          controller
              ...
              .catchError((error) {
                // Handle any errors and ensure loading is stopped
                controller.setButtonLoading('submit', false);
    ...
    : () {
        if (_formKey.currentState!.validate() && _validateForm()) {
          ...
          controller.saveinviewPageGeneralExpenseUnProcess(
            context,
            false,
            false,
            widget.items.recId!,
          ).then((_) {
            // Success - do nothing additional if not needed
          }).catchError((error) {
            // // Handle error
