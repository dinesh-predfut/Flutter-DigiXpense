...
class UserAssignmentScreen extends StatefulWidget {
  final String page;
  const UserAssignmentScreen({super.key, required this.page});
...
class _UserAssignmentScreenState extends State<UserAssignmentScreen> {
  ...
  Future<void> fetchUsers() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Users> fetchedUsers = jsonData
            .map((userJson) => Users.fromJson(userJson))
            .toList();

        fetchedUsers.removeWhere(
          (user) => selectedUsers.any((sel) => sel.userName == user.userName),
        );
        setState(() {
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildUserList(
                      ...
                      users: _filterUsers(
                        allUsers,
                        searchAvailableController.text,
                      ),
                    ),
                  ),
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              tooltip:
                                  "${AppLocalizations.of(context)!.moveAll} →",
                              color: Colors.green,
                              iconSize: 32,
              ...
              () => Row(
                ...
                children: [
                  _actionButton(
                    ...
                    false,
                    isDisabled: isSaving.value, // 👈 disable
                  ),
                  ...
                  _actionButton(
                    ...
                    () async {
                      ...
                      try {
                        ...
                        await reportModel.saveReport(context,widget.page);
                      } finally {
                        isSaving.value = false; // 👈 stop loader
                      }
                    },
                    isSaving.value, // 👈 loader
                  ),
  ...
  Widget _actionButton(
    ...
    return ElevatedButton(
      onPressed: (isLoading || isDisabled) ? null : onPressed, // 👈 disable
