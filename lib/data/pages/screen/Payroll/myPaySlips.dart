...
class MyPayslip_Dashboard extends StatefulWidget {
  const MyPayslip_Dashboard({super.key});

  @override
  State<MyPayslip_Dashboard> createState() => _MyPayslip_DashboardState();
}

class _MyPayslip_DashboardState extends State<MyPayslip_Dashboard>
  ...
  void _loadProfileImage() async {
    ...
    prefs.setString('selectedMenu', 'My Payslips');
                ...
                Expanded(
                  child: Obx(() {
                    ...
                    if (controller.filteredPayrollList.isEmpty) {
                      return  Center(
                        child: Text(
                         AppLocalizations.of(context)!.payslipsNotAvailable,
