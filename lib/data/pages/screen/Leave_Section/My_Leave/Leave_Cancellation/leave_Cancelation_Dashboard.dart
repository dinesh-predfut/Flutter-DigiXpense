...
import 'package:diginexa/data/models.dart'
    show ManageExpensesCard, GExpense, LeaveAnalytics, LeaveCancellationModel, LeaveDetailsModel, LeaveRequisition, LeaveAnalyticsFilter, Employee, UpcomingHoliday, LastAppliedLeave;
...
class CancellationLeaveDashboard extends StatefulWidget {
  ...
  @override
  State<CancellationLeaveDashboard> createState() =>
      _CancellationLeaveDashboardState();
}
                        ...
                        child: Container(
                          ...
                          child: Obx(
                            () => DropdownButton<String>(
                              value: controller
                                  .selectedLeaveStatusDropDownmyTeam
                                  .value,
                              isExpanded: true,
                              ...
                              onChanged: (String? newValue) {
                                if (newValue != null &&
                                  ...
                                  controller
                                          ...
                                          .value =
                                      newValue;
                                  controller.fetchMyteamsLeaveCancellation();
                                }
                              },
                              items: statusOptions
                                  .map(
...
void _openFilterBottomSheet(BuildContext context) {
 ...
 Widget _buildBottomList() {
  ...
  // Widget _buildLeaveEventItem(LeaveCancellationModel leave) {
  //   return Container(
  ...
  Widget _buildCardViewContent(BuildContext context) {
    return Obx(() {
      ...
      return ListView.builder(
        ...
        itemCount: controller.myCancelationfilteredLeaves.length,
        itemBuilder: (ctx, idx) {
          final item = controller.myCancelationfilteredLeaves[idx];
  ...
  Widget _buildStyledCard(LeaveCancellationModel item, BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        ...
        await controller.fetchSpecificLeaveDetailsCacelation(context, item.recId, true);
      },
      child: Card(
          ...
          child: Stack(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    '${item.leaveCancelId} / ${item.employeeId}',
                    style: const TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 14,
                    ),
                  ...
                  const SizedBox(height: 4),
                 Text(
  'Cancellation Date : ${_isoDate(item.cancellationDate)}',
