...
final Controller controller = Get.put(Controller());
  ...
  void handleLogin() async {
    ...
    bool success = await controller.signIn(context);
    ...
    if (success) {
      ...
      if (!controller.rememberMe) {
        ...
        clearSavedCredentials(); // important
      }
    }
  }
            ...
            return Stack(
              children: [
                Positioned(
                  ...
                  child: Image.asset('assets/loginLogo.png', fit: BoxFit.cover),
                ),
                Align(
                          ...
                          Row(
                            children: [
                              Checkbox(
                                ...
                                onChanged: controller.isLoadingLogin.value
                                    ? null
                                    : (value) {
                                        setState(
                              ...
                              TextButton(
                                ...
                                child: const Text(
                                  "Forgot password?",
                                  style: TextStyle(
                                    color: Color.fromARGB(255, 42, 2, 117),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Obx(() {
                            return SizedBox(
                              ...
                              child: GradientButton(
                                ...
                                onPressed: isFormValid ? handleLogin : () {},
                                disabled:
                                    !isFormValid ||
