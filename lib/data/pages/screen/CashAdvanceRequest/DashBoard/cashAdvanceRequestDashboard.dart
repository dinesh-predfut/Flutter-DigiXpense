...
class _CashAdvanceRequestDashboardState
  ...
  void _loadProfileImage() async {
    ...
    prefs.setString(
      'selectedMenu',
      AppLocalizations.of(context)!.myCashAdvances,
    );
                  ...
                  child: Obx(() {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (ctx, idx) {
                        ...
                        return Dismissible(
                          key: ValueKey(item.requisitionId),
                          ...
                          onDismissed: (direction) async {
                            ...
                            controller.cashAdvanceListDashboard.removeWhere(
                              (e) => e.requisitionId == item.requisitionId,
                            );
