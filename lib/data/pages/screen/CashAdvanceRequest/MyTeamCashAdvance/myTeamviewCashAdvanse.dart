...
class _ViewMyteamCashAdvanceExpensePageState
  ...
  void _initializeItemizeControllers() {
    itemizeControllers = widget.items!.cshCashAdvReqTrans.map((item) {
      ...
      controller.totalunitEstimatedAmount.text = item.unitEstimatedAmount
          .toString();
                                  ...
                                  TextField(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      itemController.paidAmount.text =
                                          calculatedLineAmount.toStringAsFixed(
                                            2,
                                          );
                                    ...
                                    onEditingComplete: () {
                                      ...
                                      if (value != null) {
                                        itemController.unitAmount.text = value
                                            .toStringAsFixed(2);
                                        itemController.paidAmount.text = value
                                            .toStringAsFixed(2);
                                      }
                                    },
                                    decoration: InputDecoration(
