...
class TimeSheetsReportCreateScreen extends StatefulWidget {
  ...
  @override
  _TimeSheetsReportCreateScreenState createState() =>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (widget.existingReport != null) {
        ...
        reportModel.updateFunctionalArea("TimeSheet Requisition");
        await _fetchDatasets();
      }
    });
  }
