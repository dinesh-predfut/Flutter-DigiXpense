...
import 'package:diginexa/data/models.dart' show ReportModels, Rule;
...
class TimeSheetDashboardReport extends StatefulWidget {
  const TimeSheetDashboardReport({super.key});

  @override
  State<TimeSheetDashboardReport> createState() => _TimeSheetDashboardReportState();
}

class _TimeSheetDashboardReportState extends State<TimeSheetDashboardReport>
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                     '${AppLocalizations.of(context)!.timesheet} ${AppLocalizations.of(context)!.reports}' ,
                      ...
                      Expanded(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.pushNamed(
                              context,
                              AppRoutes.timeSheetsReportCreateScreen,
                            );
                          },
                          icon: const Icon(
                            Icons.add_circle,
                        ...
                        return Dismissible(
                          ...
                          confirmDismiss: (direction) async {
                            if (direction == DismissDirection.startToEnd) {
                              ...
                              // }
                              controller.leavenavigateToEditReportScreen(
                                context,
                                item.recId,
                                true,
                              );
                              ...
                              //       context, AppRoutes.mileageDetailsPage);
                              // }
                              controller.timeSheetnavigateToEditReportScreen(
                                context,
                                item.recId,
                                true,
                              );
  ...
  Widget _buildStyledCard(ReportModels item, BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        // if (item.expenseType == "PerDiem") {
        controller.timeSheetnavigateToEditReportScreen(context, item.recId, true);
