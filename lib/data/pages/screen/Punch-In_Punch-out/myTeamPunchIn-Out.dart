...
class MyTeamPunchInOutList extends StatefulWidget {
  ...
  @override
  State<MyTeamPunchInOutList> createState() => _MyTeamPunchInOutList();
}

class _MyTeamPunchInOutList extends State<MyTeamPunchInOutList>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      controller.fetchMyteamattendanceList().then((_) {
  ...
  void _loadProfileImage() async {
    ...
    prefs.setString('selectedMenu', 'My Team Attendance');
  ...
  class AttendanceViewDialog extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        ...
        appBar: AppBar(
          title:  Text(AppLocalizations.of(context)!.viewTeamMemberAttendance),
        ...
        body: Padding(
          ...
          child: ListView(
            ...
            const SizedBox(height: 20),
            customTextField(label: AppLocalizations.of(context)!.employeeId, value: item.employeeId),
            const SizedBox(height: 20),
            customTextField(label: AppLocalizations.of(context)!.employeeName, value: item.employeeName),
            const SizedBox(height: 20),
              ...
              const SizedBox(height: 20),
              customTextField(label: AppLocalizations.of(context)!.captureType, value: item.captureMethod),
              const SizedBox(height: 20),
              customTextField(
