...
class AttendanceMISWizardParent extends StatefulWidget {
  const AttendanceMISWizardParent({Key? key}) : super(key: key);

  @override
  _LeaveMISWizardParentState createState() =>
      _LeaveMISWizardParentState();
}

class _LeaveMISWizardParentState extends State<AttendanceMISWizardParent> {
  int _currentStep = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> screens = [
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
  title: Text( '${AppLocalizations.of(context)!.leaveRequisition} ${AppLocalizations.of(context)!.reports}'),          centerTitle: true,
        ),
        body: Padding(  
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ReportModel>(
        context,
        listen: false,
      ).updateFunctionalAreaExpenseReport("Leave Requisition");
    });
  }
