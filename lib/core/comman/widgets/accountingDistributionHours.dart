...
class AccountingDistributionWidgetHours extends StatefulWidget {
  final int? index;
  ...
  final bool isEnable;
  const AccountingDistributionWidgetHours({
    super.key,
    this.index,
  ...
  @override
  State<AccountingDistributionWidgetHours> createState() =>
      _AccountingDistributionWidgetHoursState();
}

class _AccountingDistributionWidgetHoursState
    extends State<AccountingDistributionWidgetHours> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            "${strings.totalHours}: ${calculatedAmount.toStringAsFixed(2)}",
                            style: const TextStyle(
